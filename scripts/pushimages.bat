...
echo "pushing image repofortestingm2k"
%CONTAINER_RUNTIME% tag repofortestingm2k %REGISTRY_URL%/%REGISTRY_NAMESPACE%/repofortestingm2k
%CONTAINER_RUNTIME% push %REGISTRY_URL%/%REGISTRY_NAMESPACE%/repofortestingm2k

echo "pushing image repofortestingm2k-buildstage"
%CONTAINER_RUNTIME% tag repofortestingm2k-buildstage %REGISTRY_URL%/%REGISTRY_NAMESPACE%/repofortestingm2k-buildstage
%CONTAINER_RUNTIME% push %REGISTRY_URL%/%REGISTRY_NAMESPACE%/repofortestingm2k-buildstage
