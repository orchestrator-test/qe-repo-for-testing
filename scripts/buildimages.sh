...
echo 'building image repofortestingm2k-buildstage'
cd source
${CONTAINER_RUNTIME} build -f Dockerfile.buildstage -t repofortestingm2k-buildstage .
cd -

echo 'building image repofortestingm2k'
cd source
${CONTAINER_RUNTIME} build -f Dockerfile -t repofortestingm2k .
cd -
